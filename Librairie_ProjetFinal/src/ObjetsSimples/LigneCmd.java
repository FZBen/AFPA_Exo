...
public class LigneCmd {
    ...
    public Vector getVector(){
        ...
        float qt = Float.parseFloat(this.quantite);
        float prix = Float.parseFloat(prixHT);
        float prTot = (prix * qt)* (1 + Float.parseFloat(tva)/100);
        prTot = prTot *100;
        prTot = Math.round(prTot);
        prTot = prTot /100;
        
        

        v.add(this);
        v.add(this.livre.getTitle());
        v.add(this.quantite);
        v.add(this.prixHT);
        v.add(this.tva);
        v.add(String.valueOf(prTot));
