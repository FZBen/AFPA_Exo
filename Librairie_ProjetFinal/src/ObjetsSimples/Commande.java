...
public class Commande {
    ...
    public Vector getVector() {
        ...
        v.add(this);
        v.add(this.cmdDate);
        v.add(this.client.getCustomerlastname());
        v.add(this.client.getCustomerfirstname());
        v.add(this.client.getCustomermail());
        v.add(this.montantGlobal);
        v.add(this.montantPaiement);
        v.add(this.etatEnvoi);
