 ...
 * @author cda201
 */
public class JFLivreMod extends javax.swing.JFrame {
...
//refresh de la table de la fenetre mère
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFLivreMod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFLivreMod().setVisible(true);
            }
        });
